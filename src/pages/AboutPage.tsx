...
export default function AboutPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-16 pb-20 pt-8 px-4">
      <section className="text-center space-y-6">
        ...
        <div className="space-y-4">
          <motion.h1 
            ...
            className="text-4xl lg:text-6xl font-black tracking-tighter text-slate-900 dark:text-white"
          >
          ...
          <motion.p 
            ...
            className="text-lg text-slate-500 dark:text-slate-400 max-w-3xl mx-auto leading-relaxed"
          >
            {config.introDesc}
          </motion.p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          ...
          <motion.div 
            key={idx}
            whileHover={{ y: -5 }}
            className="bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 p-8 rounded-[2.5rem] shadow-sm"
          >
      ...
      <section className="bg-slate-900 dark:bg-blue-600/10 rounded-[3rem] p-8 lg:p-16 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center gap-12">
          <div className="shrink-0">
             <div className="w-48 h-48 rounded-full border-8 border-white/10 overflow-hidden shadow-2xl scale-110">
               <img 
          ...
          <div className="space-y-6 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 bg-white/10 px-4 py-1.5 rounded-full text-xs font-black tracking-widest uppercase mb-4">
              <User className="w-3 h-3" /> System Architect & Founder
            </div>
            <h2 className="text-3xl lg:text-5xl font-black tracking-tight">{config.adminName.split(' ').slice(0, -1).join(' ')} <span className="text-blue-400">{config.adminName.split(' ').slice(-1)}</span></h2>
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 pt-4">
              <div className="bg-white/5 border border-white/10 px-5 py-3 rounded-2xl flex items-center gap-3">
                 ...
                 <span className="font-bold">Sáng tạo & Đam mê</span>
              </div>
              <div className="bg-white/5 border border-white/10 px-5 py-3 rounded-2xl flex items-center gap-3">
